...
import Foreign
import Foreign.C
foreign import capi "crystal_auxillary.h random_uint" c_getRandomUInt :: IO CUInt
foreign import capi "crystal_auxillary.h random_ulong" c_getRandomULong :: IO CULong
foreign import capi "crystal_auxillary.h random_unbiased_uint" c_getRandomUnbiasedUInt :: CUInt -> CUInt -> IO CUInt
